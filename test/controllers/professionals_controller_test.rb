...
class ProfessionalsControllerTest < ActionController::TestCase
  ...
  test "should create professional" do
    assert_difference('Professional.count') do
      post :create, professional: { address: @professional.address, first_name: @professional.first_name, last_name: @professional.last_name, phone_number: @professional.phone_number, specialty: @professional.specialty }
    end
  ...
  test "should update professional" do
    patch :update, id: @professional, professional: { address: @professional.address, first_name: @professional.first_name, last_name: @professional.last_name, phone_number: @professional.phone_number, specialty: @professional.specialty }
    assert_redirected_to professional_path(assigns(:professional))
  end
